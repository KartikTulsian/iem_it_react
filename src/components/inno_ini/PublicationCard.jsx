      ...
      <Container className="publication-content">
        {selectedPub && (
          <Card className="publication-card shadow-lg p-4">
            ...
            <Card.Body>
              <h3 className="section-title-pub text-primary">Conference Publications</h3>
              <PublicationTable type={selectedPub} category="conf" />

              <h3 className="section-title-pub text-success">Journal Publications</h3>
...
function PublicationTable({ type, category }) {
  return (
    <Container className="table-responsive">
      <Table striped bordered hover responsive className="publication-table">
        <thead>
          {publications[type][category].slice(0, 2).map((headingRow, rowIndex) => (
            <tr key={rowIndex}>
        ...
        <tbody>
          {publications[type][category].slice(2).map((row, rowIndex) => (
            <tr key={rowIndex}>
